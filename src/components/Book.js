...
const Book = () => {
    ...
    const [date, setDate] = useState(new Date().setHours(9, 0, 0, 0));
        ...
        <div className="min-w-screen min-h-screen flex items-center justify-center sm:px-5 py-5 ">
            <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden border-x-2 border-b-4 border-slate-700 border-t-0" style={{ "maxWidth": "1000px" }}>
                <div className="md:flex w-full">
                    <div className="hidden md:block w-1/2 bg-blue py-10 px-10">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            <h1 className="font-bold text-3xl text-gray-900">Book Consultancy</h1>
                            <p>Please enter details to book a <span className='text-sky-900 italic'>FREE</span> consultation from the professionals</p>
                        </div>
                        <div>
                            <div className="flex -mx-3">
                                <div className="w-1/2 px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" value={name} onChange={(e)=>setName(e.target.value)}/>
                                    </div>
                                </div>
                                <div className="w-1/2 px-3 mb-5">
                            ...
                            <div className="flex -mx-3">
                                <div className="px-3 mb-5 w-fit">
                                    <label for="" className="text-xs font-semibold px-1">Pick Date</label>
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-calendar-blank-outline text-gray-400 text-lg"></i></div>
                                        ...
                                        <div className='w-full -ml-10 -mb-1 pl-10 pr-5 py-2 rounded-lg border-2 bg-white border-gray-200 outline-none focus:border-indigo-500 overflow-hidden' >
                                            <DatePicker
                                ...
                                <div className="w-[150px] min-w-[100px] px-3 mb-5">
                                    <label for="" className="text-xs font-semibold px-1">Pick Time</label>
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-clock-outline text-gray-400 text-lg"></i></div>
                                        <div className='w-full -ml-10 -mb-1 pl-10 pr-2  py-2 rounded-lg border-2 bg-white border-gray-200 outline-none focus:border-indigo-500 overflow-hidden' >
                                            <DatePicker
                                                wrapperClassName='wrapper'
                                                selected={date}
                                                onChange={(date) => setDate(date)}
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-12">
                                    <label for="" className="text-xs font-semibold px-1">Optional Message</label>
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <textarea rows={4} type="password" className="flex flex-col justify-center items-center w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Type your awsome Message!"  value={message} onChange={(e)=>setMessage(e.target.value)}/>
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
